<?php
    ...
    require_once "../classes/user.php"; //suggestion function

    $user = new User;
    $user_list = $user->getUsers();
    //$user_list contains the reslut from the getUsers SQL
?>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php
                    //fetch_assoc fetches result row as an associative array
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="removeUser.php?user_id=<?=$user['id']?>" class="btn btn-outline-danger btn-sm">Remove</a>
                            </td>
                        </tr>
                    <?php
                    }
